...
const Item = () => {
  ...
  const fetchItems = async () => {
    try {
      const response = await axios.get('https://fancy-palace-backend.vercel.app/api/blenders');
  ...
  const handleAddItem = async () => {
    try {
      const response = await axios.post('https://fancy-palace-backend.vercel.app/api/blenders', itemData);
  ...
  const handleDecreaseQuantity = async (code) => {
    try {
      const response = await axios.patch(`https://fancy-palace-backend.vercel.app/api/blenders/${code}/decrease`);
