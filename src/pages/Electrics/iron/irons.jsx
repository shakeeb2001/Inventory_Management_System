...
const Item = () => {
  ...
  const handleEditItem = async () => {
    try {
      const response = await axios.put(`https://fancy-palace-backend.vercel.app/api/iron/${currentItemCode}`, itemData);
  ...
  const handleDeleteItem = async (code) => {
    try {
      await axios.delete(`https://fancy-palace-backend.vercel.app/api/iron/${code}`);
  ...
  const handleDecreaseQuantity = async (code) => {
    try {
      const response = await axios.patch(`https://fancy-palace-backend.vercel.app/api/iron/${code}/decrease`);
      const updatedItems = items.map(item =>
