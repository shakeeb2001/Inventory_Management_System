...
const Item = () => {
  ...
  const handleEditItem = async () => {
    try {
      const response = await axios.put(`https://fancy-palace-backend.vercel.app/api/gascooker/${currentItemCode}`, itemData);
  ...
  const handleDeleteItem = async (code) => {
    try {
      await axios.delete(`https://fancy-palace-backend.vercel.app/api/gascooker/${code}`);
