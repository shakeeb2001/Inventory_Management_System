...
const Item = () => {
  ...
  const fetchItems = async () => {
    try {
      const response = await axios.get('http://localhost:4000/api//plastic-metal');
  ...
  const handleAddItem = async () => {
    try {
      const response = await axios.post('http://localhost:4000/api//plastic-metal', itemData);
  ...
  const handleDecreaseQuantity = async (code) => {
    try {
      const response = await axios.patch(`http://localhost:4000/api//plastic-metal/${code}/decrease`);
